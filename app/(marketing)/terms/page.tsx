      ...
      <div className="container mx-auto px-4 max-w-4xl relative z-10">
        <div className="bg-white rounded-2xl shadow-elevated p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-800/80 space-y-6">
            ...
            <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">1. Eligibility & Account Responsibilities</h2>
            ...
            <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">2. Subscription and Payments</h2>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">4. Educational Content & UGC</h2>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">5. Third-Party Services</h2>
            <p className="font-medium text-gray-800 mb-3">Masterly uses the following third-party services to deliver core functionality:</p>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">8. Disclaimers & Limitation of Liability</h2>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">9. Changes to These Terms</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">10. Apple App Store Terms</h2>
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-gray-800 mb-2">10.1 EULA Acknowledgement</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-800 mb-2">10.2 Scope of License</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-800 mb-2">10.3 Product Claims and Liability</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-800 mb-2">10.4 Intellectual Property</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-800 mb-2">10.5 Your Legal Representations</h3>
                <p>
                  You represent and warrant that: (i) you are not located in a country that is subject to a U.S. Government embargo, or that has been designated by the U.S. Government as a "terrorist supporting" country; and (ii) you are not listed on any U.S. Government list of prohibited or restricted parties. You may not use the App if any of these representations is false.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-gray-800 mb-2">10.6 Third-Party Beneficiary</h3>
                <p>
